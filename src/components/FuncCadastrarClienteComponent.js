...
const FuncCadastrarClienteComponents = (props) => {
  ...
  const verificaCamposVazios = () => {
    if(values.nome=== '' || values.cpf === '' || values.email === '' || values.telefone === '' || values.endereco === ''){
      abrirVerificar();
    }else{
      handleClickOpen();
    }
    ...
    <div className="divii">
      ...
      <div>
        ...
        <div style={{ flexDirection: "row", display: "flex" ,width:300}}>
            ...
            <button className="loginButton" style={{ marginLeft:300,marginTop:30}} onClick={verificaCamposVazios}>
              {""}
              Cadastrar
            </button>
            <Dialog
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  Finalizar o cadastro e salvar as informações no sistema permite que o cliente tenha acesso as funcionalidades da Pizza-e.
                </DialogContentText>
              </DialogContent>
              <DialogActions>
          ...
          <Dialog
              ...
              aria-describedby="alert-dialog-description"
            >
              <DialogTitle id="alert-dialog-title">{"Cadastro realizado com sucesso!  "}<FiCheck size={35} color={"green"}></FiCheck></DialogTitle>
              
              <DialogContent>
                
                <DialogContentText id="alert-dialog-description">
                  Um email será enviado ao cliente para que ele finalize a etapa de criação da senha.
                </DialogContentText>
              </DialogContent>
              <DialogActions>
          ...
          <Dialog
              ...
              aria-describedby="alert-dialog-description"
            >
              <DialogTitle id="alert-dialog-title">{"O Cadastro não pode ser realizado!  "}<FiX size={35} color={"red"}></FiX></DialogTitle>
          ...
          <Dialog
              ...
              aria-describedby="alert-dialog-description"
            >
              <DialogTitle id="alert-dialog-title">{"Deseja voltar para a tela de clientes?"}</DialogTitle>
              <DialogContent>
              </DialogContent>
              <DialogActions>
